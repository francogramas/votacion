...
<head>
	<title>Index De La Registraduría </title>
	<!-- Bootstrap -->
		...
		<div class="container main">
			<div class="row grids_of_3">
				...
				<div class="col-md-6 grid1_of_3">
					...
					<div class="rd_more1">
					<a href='{{Route('registrocandidato.index')}}'  class="btn_style">registrarse </a>
				...
				<div class="col-md-6 grid1_of_3">
					...
					<img src="{{asset('plugins/assets/images/icon1.png')}}" class="img-responsive" />
					<p>En este modulo se podrá observar todos los resultados de la votación</p>
					<div class="rd_more1">
					<a href='{{Route('resultados.index')}}'  class="btn_style">registrarse </a>
					</div>
                </div>
